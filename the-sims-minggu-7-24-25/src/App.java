...
public class App {
    ...
    private final Map<PageType, Pages> pages = Map.ofEntries(
        ...
        Map.entry(PageType.MANAGE_HOUSEHOLD_INFORMATION, new ManageHouseholdInformation(householdData, houseName, householdDetails)),
        Map.entry(PageType.SIM_DETAILS_SELECT, new SimDetailsSelect(householdDetails, houseName)),
        // Map.entry(PageType.SIM_DETAILS_INFORMATION, new SimDetailsInformation(householdData, houseName))
    );
